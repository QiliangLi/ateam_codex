...
铲屎官让布偶猫深度研究了 SillyTavern 的架构（详见 `docs/archive/2026-02/research/sillytavern-phone-ui-research.md`），提炼出三个核心模式：
...
> [事实] 酒馆研究的完整分析见 `docs/archive/2026-02/research/sillytavern-phone-ui-research.md`，包含了取舍决策的详细论证。
